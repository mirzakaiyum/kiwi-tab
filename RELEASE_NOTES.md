...
- Separate background types: Choose between **Images** or **Videos**
...
- Widget limit increased to 8 pinned widgets
- Drag and drop reordering for widgets
- Version now synced automatically from package.json
- Improved layout with less unnecessary spacing
