# Kiwi Tab: A Modern, Minimalist Home Page for Your Browser
...
- ⚡ Fast & lightweight!
- 🔎 Smart search bar with multi-engine support.
...
- Suggest new **widget ideas** or improvements.
- Share your favorite **wallpaper ideas**.
- Help with **translations** to new languages.
...
If you enjoy Kiwi Tab, please consider:

- Giving the project a star on GitHub ⭐️
...
- **Kaiyum Mirza** · [GitHub](https://github.com/MakFissh)
...
```bash
# Clone the repo
git clone https://github.com/MakFissh/kiwi-tab.git
...
- Load unpacked and select the `dist` folder after running `npm run build`.
