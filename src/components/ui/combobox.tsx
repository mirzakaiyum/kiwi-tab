        ...
        <InputGroup className={cn("w-auto", className)}>
            ...
            <InputGroupAddon align="inline-end">
                {showTrigger && (
                    <ComboboxTrigger
                        className={cn(
                            "size-6 p-0 group-has-data-[slot=combobox-clear]/input-group:hidden data-pressed:bg-transparent gap-2 rounded-4xl text-sm shadow-none flex items-center justify-center",
...
function ComboboxList({ className, ...props }: ComboboxPrimitive.List.Props) {
    return (
        <ComboboxPrimitive.List
            ...
            className={cn(
                "max-h-[min(calc(18rem-2.25rem),calc(var(--available-height)-2.25rem))] scroll-py-1 overflow-y-auto p-1 data-empty:p-0 overscroll-contain",
                className,
            )}
            {...props}
        />
